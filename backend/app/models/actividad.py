...
class Actividad(Base):
    ...
    lugar = Column(String(600), nullable=False)
    fecha_inicio = Column(Date, nullable=False)
    fecha_fin = Column(Date, nullable=True)
    hora_inicio = Column(Time, nullable=True)
    hora_fin = Column(Time, nullable=True)
    tipo = Column(String(100), nullable=False)         # Taller | Evento | Actividad
    organizador = Column(String(200), nullable=False)  # Secretaría | SENA | Otro
    ...
    hoja_sena                = Column(String(150), nullable=True)  # hoja del portafolio
    codigo_sena              = Column(String(120), nullable=True)  # código SOFIA
    version_sena             = Column(String(300), nullable=True)  # versión / texto del programa
    nivel_sena               = Column(String(250), nullable=True)  # TÉCNICO / TECNÓLOGO / etc.
    red_sena                 = Column(String(600), nullable=True)  # red de conocimiento / familia
    iniciativas_sena         = Column(String(600), nullable=True)  # iniciativas asociadas
    estado_sofia             = Column(String(200), nullable=True)  # estado en sistema SOFIA
    campana_sena             = Column(String(200), nullable=True)  # etiqueta de campaña
    ...
    duracion_texto_sena      = Column(String(200), nullable=True)  # TITULADA VIRTUAL "27 meses"
